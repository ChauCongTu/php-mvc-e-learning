<footer class="bg-theme text-white">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="mt-3">
                    ...
                    <!-- Button Telegram -->
                    <a href="#" class="btn btn-primary btn-social" style="background-color: #2CA5E0">
                        <i class="fab fa-telegram-plane"></i> Telegram
                    </a>

                    <!-- Button Github -->
                    <a href="#" class="btn btn-primary btn-social" style="background-color: #211F1F">
