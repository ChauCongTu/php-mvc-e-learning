        ...
        <div class="row mt-2">
            <div class="col-md-6 mb-2">
                <form action="" method="post">
                    <textarea name="textToTranslate" rows="10"><?php echo (isset($textToTranslate) ? $textToTranslate : false); ?></textarea>
                    <button type="submit" name="translate" class="btn btn-danger float-end w-25"><i class="fa-solid fa-arrow-right-arrow-left"></i> Dịch</button>
                </form>
            </div>
            <div class="col-md-6">
                <textarea rows="10" disabled><?php echo (isset($translated_text) ? $translated_text : false); ?></textarea>
            </div>
        </div>
    </div>
</section>