<section class="profile container">
    <?php
    if (Session::data('User')['role'] == 3 || Session::data('User')['user_id'] == $user['user_id']) {
    ?>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <select name="gender" class="form-control">
                                        ...
                                        <option value="2" <?php echo ($user['gender'] == 2) ? "selected" : false; ?>>Khác</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-2">
    ...
    <?php
        ...
        echo '<div class="p-3 text-center text-danger h3">Không đủ thẩm quyền!</div>';
    }
    ?>
</section>