        ...
        <div class="col-md-8">
            <div class="user-info mobile-center">
                ...
                if (Session::data('User') != null) {
                    ...
                    if ($user['user_id'] == Session::data('User')['user_id']) {
                        echo '<a href="" class="btn btn-primary rounded-0 btn-sm"><i class="fa-solid fa-pen"></i> Chỉnh sửa</a>';
                    }
                    if (Session::data('User')['role'] == 1) {
                        if ($user['role'] != -1) {
                            echo ' <a href="" class="btn btn-danger rounded-0 btn-sm"><i class="fa-solid fa-lock"></i> Khóa</a>';
                        }
                    }
                    if (Session::data('User')['role'] == 3) {
                        if ($user['role'] == -1) {
                            echo ' <a href="" class="btn btn-danger rounded-0 btn-sm"><i class="fa-solid fa-lock-open"></i> Mở Khóa</a>';
                        }
                        else {
                            echo ' <a href="" class="btn btn-danger rounded-0 btn-sm"><i class="fa-solid fa-lock"></i> Khóa</a>';
                        }
                        echo ' <a href="" class="btn btn-danger rounded-0 btn-sm"><i class="fa-solid fa-trash"></i> Xóa tài khoản</a>';
                    }
                }
        ...
        <div class="col-md-8">
            ...
            <div class="user-info">
                ...
                <div class="content">
                    <table>
                        <tr>
                            <td class="fw-bold" width="40%">Ngày sinh: </td>
